...
func (s *SmartContract) Invoke(APIstub shim.ChaincodeStubInterface) sc.Response {
	...
	case "createPrivateCarImplicitForSeedsAssociation":
		return s.createPrivateCarImplicitForSeedsAssociation(APIstub, args)
	case "createPrivateCarImplicitForFarmersAssociation":
		return s.createPrivateCarImplicitForFarmersAssociation(APIstub, args)
...
func (s *SmartContract) readPrivateCar(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	// collectionCars, collectionCarPrivateDetails, _implicit_org_SeedsAssociationMSP, _implicit_org_FarmersAssociationMSP
...
func (s *SmartContract) readPrivateCarIMpleciteForSeedsAssociation(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {

	if len(args) != 1 {
		return shim.Error("Incorrect number of arguments. Expecting 1")
	}

	carAsBytes, _ := APIstub.GetPrivateData("_implicit_org_SeedsAssociationMSP", args[0])
	return shim.Success(carAsBytes)
}
...
func (s *SmartContract) createPrivateCarImplicitForSeedsAssociation(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	err := APIstub.PutPrivateData("_implicit_org_SeedsAssociationMSP", args[0], carAsBytes)
	if err != nil {
...
func (s *SmartContract) createPrivateCarImplicitForFarmersAssociation(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	err := APIstub.PutPrivateData("_implicit_org_FarmersAssociationMSP", args[0], carAsBytes)
	if err != nil {
		return shim.Error("Failed to add asset: " + args[0])
	}
	return shim.Success(carAsBytes)
