createcertificatesForFarmersAssociation() {
  echo
  ...
  fabric-ca-client enroll -u https://admin:adminpw@localhost:7054 --caname ca.farmersAssociation.example.com --tls.certfiles ${PWD}/fabric-ca/farmersAssociation/tls-cert.pem

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-7054-ca-farmersAssociation-example-com.pem
  ...
  echo
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:7054 --caname ca.farmersAssociation.example.com -M ${PWD}/../crypto-config/peerOrganizations/farmersAssociation.example.com/peers/peer0.farmersAssociation.example.com/msp --csr.hosts peer0.farmersAssociation.example.com --tls.certfiles ${PWD}/fabric-ca/farmersAssociation/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:7054 --caname ca.farmersAssociation.example.com -M ${PWD}/../crypto-config/peerOrganizations/farmersAssociation.example.com/peers/peer0.farmersAssociation.example.com/tls --enrollment.profile tls --csr.hosts peer0.farmersAssociation.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/farmersAssociation/tls-cert.pem
  ...
  mkdir -p ../crypto-config/peerOrganizations/farmersAssociation.example.com/peers/peer1.farmersAssociation.example.com

  echo
  echo "## Generate the peer1 msp"
  echo
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:7054 --caname ca.farmersAssociation.example.com -M ${PWD}/../crypto-config/peerOrganizations/farmersAssociation.example.com/peers/peer1.farmersAssociation.example.com/msp --csr.hosts peer1.farmersAssociation.example.com --tls.certfiles ${PWD}/fabric-ca/farmersAssociation/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:7054 --caname ca.farmersAssociation.example.com -M ${PWD}/../crypto-config/peerOrganizations/farmersAssociation.example.com/peers/peer1.farmersAssociation.example.com/tls --enrollment.profile tls --csr.hosts peer1.farmersAssociation.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/farmersAssociation/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://user1:user1pw@localhost:7054 --caname ca.farmersAssociation.example.com -M ${PWD}/../crypto-config/peerOrganizations/farmersAssociation.example.com/users/User1@farmersAssociation.example.com/msp --tls.certfiles ${PWD}/fabric-ca/farmersAssociation/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://farmersAssociationadmin:farmersAssociationadminpw@localhost:7054 --caname ca.farmersAssociation.example.com -M ${PWD}/../crypto-config/peerOrganizations/farmersAssociation.example.com/users/Admin@farmersAssociation.example.com/msp --tls.certfiles ${PWD}/fabric-ca/farmersAssociation/tls-cert.pem
